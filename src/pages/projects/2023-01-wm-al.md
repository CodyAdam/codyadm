...
More information about the front end [here](https://github.com/CodyAdam/my-admin-panel/front-end.md).
...
More information about the backend [here](https://github.com/CodyAdam/my-admin-panel/back-end.md).
...
![Backend monitoring dashboard](https://github.com/CodyAdam/my-admin-panel/assets/dashboard.png)
